    ...
    $GLOBALS['TL_SUBCL'] = [
        'contao-UIkit' => [
            ...
            'sets' => [
                ...
                '33x33x33' => [['uk-width-1-3@s'], ['uk-width-1-3@s'], ['uk-width-1-3@s']],
                '50x50 (mobil)' => [['uk-width-1-2'], ['uk-width-1-2']],
                '50x50' => [['uk-width-1-2@s'], ['uk-width-1-2@s']],
                '33x66 (mobil)' => [['uk-width-1-3'], ['uk-width-2-3']],
                '33x66' => [['uk-width-1-3@s'], ['uk-width-2-3@s'],],
                '66x33' => [['uk-width-2-3@s'], ['uk-width-1-3@s'],],
                '100%' => [['uk-width-1-1'],],
